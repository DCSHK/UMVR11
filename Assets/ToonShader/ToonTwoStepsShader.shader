Shader "Toon/Basic/TwoSteps"
{
    Properties
    {
        ...
        _OutlineThreshold ("Outline Threshold", Range(0, 1)) = 0.1 // 描邊閾值
        _OutlineWidth ("Outline Width", Range(0, 0.1)) = 0.05 // 描邊寬度
    }
    ...
    SubShader
    {
        ...
        // 在這個範例中，將 specular 相關的變數設為較小的值或固定值
        //fixed3 _SpecColor = fixed3(0.2, 0.2, 0.2); // 較低的反射顏色
        float _SpecSmooth = 0.1; // 較小的高光平滑度
        fixed _Shininess = 0.5; // 較小的光滑度
        ...
        inline fixed4 LightingToon(SurfaceOutput s, half3 lightDir, half3 viewDir, half atten)
        {
            ...
            // specular
            float spec = pow(ndh, s.Specular * 5.0) * s.Gloss;//這裡的5.0調整高光
            spec *= atten;
