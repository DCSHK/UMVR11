...
namespace Movementsystem
{
    public class CameraZoom : MonoBehaviour
    {
        ...
        [SerializeField] [Range(0f, 10f)] private float minmunDistance = 1f;
        [SerializeField] [Range(0f, 10f)] private float maxmunDistance = 6f;
        ...
        private void Zoom()
        {
            ...
            currentTargetDistance = Mathf.Clamp(currentTargetDistance + zoomValue,minmunDistance,maxmunDistance);
